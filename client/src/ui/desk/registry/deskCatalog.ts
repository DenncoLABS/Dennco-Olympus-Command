...
export const deskAppCatalog: DeskAppDefinition[] = [
  ...
  { id: 'services', label: 'Services', icon: '◫', view: 'services', module: 'svc', group: 'System', status: 'active', description: 'Service app workspace for Proxmox, NethServer, PBX, DVR, and related consoles.', surfaces: ['desk', 'dock', 'apps'], order: 70 },
  ...
  { id: 'zabbix', label: 'Zabbix', icon: '⬢', view: 'zbx', module: 'zbx', group: 'System', status: 'active', description: 'Zabbix monitoring workspace with toolbar and embedded GUI surface.', surfaces: ['desk', 'dock', 'apps'], order: 85 },
  ...
  { id: 'labnode', label: 'Lab Node', icon: '◬', view: 'labnode', module: 'labnode', group: 'System', status: 'active', description: 'Lab node workspace for infrastructure nodes and test systems.', surfaces: ['desk', 'dock', 'apps'], order: 115 },
