...
const HEIGHT_KEY = 'olympus.desktop.height.clean.v1';
const DOCK_KEY = 'olympus.desktop.dock.clean.v1';
const VIEW_KEY = 'olympus.desktop.view.clean.v1';
const ACTIVE_APP_KEY = 'olympus.desktop.activeApp.clean.v1';
...
export const OlympusDesktopManagerClean: React.FC = () => {
  ...
  const openIntelMaps = () => {
    setOpen(true);
    setActiveView('apps');
    setActiveDeskApp('intel-maps');
  };

  const openCad = () => {
    setOpen(true);
    setActiveView('apps');
    setActiveDeskApp('cad');
    setActiveModule('cad');
  };
...
function SettingsView() { return <div><SectionTitle title="Settings" subtitle="Desk height, dock placement, app bar behavior, and future OS preferences." /></div>; }
