...
async function loadMapImage(map: maplibre.Map, id: string, url: string) {
...
export const MaritimePage: React.FC = () => {
  ...
  const onLoad = useCallback(async (e: { target: maplibre.Map }) => {
    await loadMapImage(e.target, 'maritime-vessel', '/assets/icons/maritime-vessel.svg');
    await loadMapImage(e.target, 'maritime-vessel-moored', '/assets/icons/maritime-vessel-moored.svg');
    await loadMapImage(e.target, 'maritime-static', '/assets/icons/maritime-static.svg');
  }, []);
